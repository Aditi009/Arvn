...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        //
        Route::get('products', 'MlmController@product')->name('product');
        Route::post('product/store', 'MlmController@productStore')->name('product.store');
        Route::get('product/edit/{id}', 'MlmController@productEdit')->name('product.edit');
